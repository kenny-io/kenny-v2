      ...
      <TheWrapper>
        <div class="flex flex-col items-center md:flex-row md:justify-center text-[#ABABAB] px-16">
          <div class="md:w-3/4 md:mt-0 mt-6 order-2 md:order-none">
            <h1 class="md:text-left text-center text-4xl md:text-6xl font-semibold tracking-tighter text-[#fff]">Articles
            </h1>
            <p class="text-base w-[350px] sm:w-full md:text-xl mt-6 text-center md:text-left">
              Writing is a huge part of my content delivery approach. It's the fastest way I know to quickly share the
              things I've learnt in the course of my work and other activities.
            </p>
            <p class="text-base w-[350px] sm:w-full md:text-xl text-center md:text-left mt-4">
              I have mostly written content that are published on other platforms, but I've also decided to write
              specifically for my blog here.
            </p>
          </div>
      ...
      <TheWrapper>
          ...
          <div class="w-full px-4 py-2 md:py-4 border border-[#383838] rounded-md relative flex items-center">
            <div>
              <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 28 28" fill="none">
                ...
                <path d="M25.9985 25.9971L20.1992 20.1979" stroke="#626262" stroke-width="4" stroke-linecap="round"
            ...
            <input
              ...
              placeholder="Search articles" type="text" id="name" name="name" v-model="searchQuery" required>
          </div>
        </div>
        <div class="text-[#999] flex items-center py-4">
          ...
          <div class="flex overflow-x-scroll scrollbar-hide snap-x">
            ...
            <button v-if="selectedCategory" @click="clearSelectedCategory"

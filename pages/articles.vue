            ...
            <TheWrapper>
                <div class="flex flex-col items-center md:flex-row md:justify-center text-[#ABABAB] px-16">
                    <div class="md:w-3/4 md:mt-0 mt-6 order-2 md:order-none">
                        ...
                        <p class="text-base w-[350px] sm:w-full md:text-xl text-center md:text-left mt-4">
            ...
            <TheWrapper>
                <div>
                    <div class="w-full px-4 py-2 md:py-4 border border-[#383838] rounded-md relative flex items-center">
                        ...
                        <input class="bg-transparent rounded-xl w-full h-[45px] pl-4 py-3 text-[#999] text-xl md:text-2xl font-semibold tracking-[-0.84px] focus:border-none active:border-none focus-visible:border-none focus:outline-none placeholder:text-[#878787]" placeholder="Search articles" type="text" id="name" name="name" required>
                    </div>
                </div>

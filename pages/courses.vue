            ...
            <TheWrapper>
                <div class="flex text-[#ABABAB] px-16">
                    <div class="w-3/4 mt-20">
                        <h1 class="text-6xl font-semibold tracking-tighter text-[#fff]">Level up as a devrel</h1>
                        <p class="text-xl mt-6">
                            I am a developer based in Lagos, Nigeria focused on creating interactive digital experiences on
                            the
                            web, working with brands and industry leaders such as DISNEY, PAYSTACK, JELLY, and NULL amongst
        ...
        <section>
            <TheWrapper>
                <div class="text-center w-4/6 py-56 px-28 mx-auto">
                    <h2 class="text-4xl text-[#F5F5F5] tracking-[-1.26px]">Over 1,300 course lessons and 200+ hours
                        included:</h2>
                </div>
            </TheWrapper>
        </section>

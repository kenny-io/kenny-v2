            ...
            <TheWrapper>
                <div class="flex text-[#ABABAB] px-16">
                    <div class="w-3/4 mt-20">
                        <h1 class="text-8xl font-semibold tracking-tighter text-[#fff]">Speaking</h1>
            ...
            <TheWrapper>
                <div>
                    <div class="w-full px-4 py-4 border border-[#383838] rounded-md relative flex items-center">
                        ...
                        <input class="bg-transparent rounded-xl w-full h-[45px] pl-4 py-3 text-[#999] text-2xl font-semibold tracking-[-0.84px] focus:border-none active:border-none focus-visible:border-none focus:outline-none placeholder:text-[#878787]" placeholder="Search talks" type="text" id="name" name="name" required>
                    </div>
                </div>

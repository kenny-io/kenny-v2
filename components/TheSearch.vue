...
const articleCategories = categories || (ref([]) as any); // Use provided categories or default to empty array

const filteredContent = computed(() => {
  let results = content?.value || []; // Use provided content or default to empty array

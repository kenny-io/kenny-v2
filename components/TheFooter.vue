<template>
  <footer>
    <TheWrapper>
      <div
        class="border text-white flex flex-col items-center px-4 pt-3 pb-24 rounded-3xl"
      >
        <h3
          class="text-4xl tracking-tighter inline-flex px-[20px] py-[18px] -mt-14 bg-black"
        >

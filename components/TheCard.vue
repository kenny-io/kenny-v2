  ...
  <div
    class="hover:border-gray-200/50 hover:transition-colors hover:duration-1000 ease-in-out border border-gray-200/20 rounded-r-2xl rounded-l-2xl overflow-hidden relative">
      ...
      <div class="w-full h-[490px]">
        <img class="object-cover w-full" :src="article?.coverImage?.url || article?.image || article?.thumbnails?.high.url || 'https://res.cloudinary.com/kennyy/image/upload/v1695921469/AI_Generated_Image_13_d1aaw0.jpg'" alt="card-header-image">
      </div>
          ...
          <div
            ...
            <span class="text-[#918F8F] h-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24">
                <path fill="currentColor" d="M16.175 13H4v-2h12.175l-5.6-5.6L12 4l8 8l-8 8l-1.425-1.4l5.6-5.6Z" />
              </svg>
            </span>
          </div>
        </a>
